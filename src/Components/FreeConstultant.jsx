...
function FreeConstultant() {
  ...
  return (
    <div className="flex flex-col items-center cursor-default text-center py-12 px-2 my-15 sm:px-6 md:px-12 bg-gray-100 mx-2 lg:mx-20 sm:mx-5 md:mx-10 rounded-2xl shadow-xl scroll-m-20">
